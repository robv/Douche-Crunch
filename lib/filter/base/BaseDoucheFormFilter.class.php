...
abstract class BaseDoucheFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'twitter_verified'    => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'twitter_followers'   => new sfValidatorPass(array('required' => false)),
      'twitter_tweets'      => new sfValidatorPass(array('required' => false)),
      'twitter_friends'     => new sfValidatorPass(array('required' => false)),
      'twitter_verified'    => new sfValidatorPass(array('required' => false)),
