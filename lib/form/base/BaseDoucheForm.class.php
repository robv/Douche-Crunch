...
abstract class BaseDoucheForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'twitter_verified'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'twitter_followers'   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'twitter_tweets'      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'twitter_friends'     => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'twitter_verified'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
